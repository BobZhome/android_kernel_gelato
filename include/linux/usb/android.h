...
struct usb_mass_storage_platform_data {
	...
	/* LGE_CHANGES_S [moses.son@lge.com] 2011-04-07, usb_mass_storage_platform_data defined in android_composite.h is deffrent.  */
	char can_stall;
	/* LGE_CHANGES_E [moses.son@lge.com] 2011-04-07 */
	/* number of LUNS */
	int nluns;
};
