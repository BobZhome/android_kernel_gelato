...
// LGE_CHANGE_S [2011.02.13] [myeonggyu.son@lge.com] [gelato] read pcb revision [START]
#ifdef CONFIG_LGE_PCB_VERSION
extern void lge_set_hw_version_string(char *pcb_version);
#endif
// LGE_CHANGE_E [2011.02.13] [myeonggyu.son@lge.com] [gelato] read pcb revision [END]
...
static ssize_t lg_show_hw_version(struct sys_device *dev, struct sysdev_attribute *attr, char *buf)
{
