...
#define LCD_RESET_GPIO		102
#else
#define LCD_RESET_GPIO		32
#endif
...
/* LGE_CHANGE [hoseok.kim@lge.com] 2011-01-13, support the Sharp Panel (Novatek DDI) */
...
static int mddi_auo_pmic_backlight(int level)
{
	/* TODO: Backlight control here */
	return 0;
}

static struct msm_panel_auo_pdata mddi_auo_panel_data = {
	.gpio = LCD_RESET_GPIO,				/* lcd reset_n */
	.pmic_backlight = mddi_auo_pmic_backlight,
	.initialized = 1,
};

static struct platform_device mddi_auo_panel_device = {
	.name	= "mddi_auo_hvga",
	.id 	= 0,
	.dev	= {
...
void __init lge_add_lcd_devices(void)
{
	...
	platform_device_register(&mddi_auo_panel_device);
#endif
