...
// LGE_CHANGE_S [myeonggyu.son@lge.com] [2011.04.14] [gelato] ETA key logging [START]
#ifdef CONFIG_MACH_MSM7X27_GELATO
extern uint16_t max_x;
extern uint16_t max_y;
#endif
// LGE_CHANGE_E [myeonggyu.son@lge.com] [2011.04.14] [gelato] ETA key logging [END]
...
// LGE_CHANGE_S [myeonggyu.son@lge.com] [2011.04.14] [gelato] ETA key logging [START]
#ifdef CONFIG_MACH_MSM7X27_GELATO
					ats_mtc_key_log1.x_hold = (value*320/max_x);
#endif
// LGE_CHANGE_E [myeonggyu.son@lge.com] [2011.04.14] [gelato] ETA key logging [END]
					touch_status++;
					break;
...
// LGE_CHANGE_S [myeonggyu.son@lge.com] [2011.04.14] [gelato] ETA key logging [START]
#ifdef CONFIG_MACH_MSM7X27_GELATO
					ats_mtc_key_log1.y_code = (value*480/max_y);
#endif
// LGE_CHANGE_E [myeonggyu.son@lge.com] [2011.04.14] [gelato] ETA key logging [END]
					touch_status++;
					break;
...
static int ats_event_log_probe(struct platform_device *pdev)
{
	int rc = 0 ;
	return rc;
}
