...
/* LGE_CHANGE_S [jisung.yang@lge.com] 2010-04-24, BCM4325 control */
	...
	/* GPIO config */
/* LGE_CHANGE_S, [dongseok.ok@lge.com], 2011-02-05, <Add BCM4330> */
	gpio_tlmm_config(GPIO_CFG(CONFIG_BCM4330_GPIO_WL_RESET, 0, 
							  GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, 
							  GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_set_value(CONFIG_BCM4330_GPIO_WL_RESET, 0);
	
	gpio_tlmm_config(GPIO_CFG(CONFIG_BCM4330_GPIO_WL_HOSTWAKEUP, 0, 
...
/* LGE_CHANGE_E, [dongseok.ok@lge.com], 2011-02-05, <Add BCM4330> */
