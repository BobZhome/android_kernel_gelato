...
/* LGE_CHANGES_S [moses.son@lge.com] 2011-04-15, if ret is 0, msm_hsusb_is_serial_num_null is called again */
#if 0		
		if (ret)
#endif	
/* LGE_CHANGES_E [moses.son@lge.com] 2011-04-15 */
