...
#define QWERTY_SDA_OUTPUT()	{ gpio_direction_output(KEY_SDA_PIN,GPIO_LOW_VALUE); udelay(25);}
...
#define QWERTY_SCL_OUTPUT()	{ gpio_direction_output(KEY_SCL_PIN,GPIO_LOW_VALUE); udelay(25); }
