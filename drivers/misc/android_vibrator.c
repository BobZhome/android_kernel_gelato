...
static int android_vibrator_initialize(void)
{
	...
	// LGE_CHANGE_S [myeonggyu.son@lge.com] [2011.02.06] [gelato] do gpio_request before setting up gpio direction in/output [START]	
	gpio_request(vibe_data->pwm_gpio,"vibrator_pwm");
	// LGE_CHANGE_E [myeonggyu.son@lge.com] [2011.02.06] [gelato] do gpio_request before setting up gpio direction in/output [END]
